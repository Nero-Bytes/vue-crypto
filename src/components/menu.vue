    ...
    <template v-if="layoutType === 'twocolumn'">
      <SimpleBar class="navbar-nav" id="navbar-nav">
        ...
        <template v-if="!isAdminRoute">
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'crypto default' }">
              <i class="ri-dashboard-line"></i>
              <span data-key="t-dashboard">{{ $t("t-dashboard") }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'crypto users' }">
              <i class="ri-user-line"></i>
              <span data-key="t-users">{{ $t("t-users") }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'crypto orders' }">
              <i class="ri-file-list-line"></i>
              <span data-key="t-orders">{{ $t("t-orders") }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'crypto Positions' }">
              <i class="ri-money-dollar-circle-line"></i>
              <span data-key="t-Positions">{{ $t("t-Positions") }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'crypto leads' }">
              <i class="ri-star-line"></i>
              <span data-key="t-leads">{{ $t("t-leads") }}</span>
            </router-link>
          </li>
          <!-- <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'crypto buy/sell' }">
              <i class="ri-exchange-line"></i>
              <span data-key="t-buy-sell">{{ $t("t-buy-sell") }}</span>
            </router-link>
          </li> -->
          <li class="nav-item">
          ...
          <li class="nav-item">
            <b-link href="#sidebarProfile" class="nav-link" data-bs-toggle="collapse" role="button"
              ...
              <i class="ri-user-line"></i>
              <span data-key="t-profile">{{ $t("t-profile") }}</span>
            </b-link>
            <div class="collapse menu-dropdown" id="sidebarProfile">
              <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                  <router-link to="/profile" class="nav-link" data-key="t-my-account">
                    {{ $t("t-my-account") }}
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/my-wallet" class="nav-link" data-key="t-wallet">
                    {{ $t("t-wallet") }}
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/profile-setting" class="nav-link" data-key="t-settings">
                    {{ $t("t-settings") }}
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/profile-kyc" class="nav-link" data-key="t-kyc">
                    {{ $t("t-kyc") }}
                  </router-link>
                </li>
              </ul>
          ...
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'crypto strategies ' }">
              ...
              <span data-key="t-ico">{{ $t("t-ico") }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'crypto billing' }">
              <i class="ri-money-dollar-circle-line"></i>
              <span data-key="t-billing">{{ $t("t-billing") }}</span>
            </router-link>
          </li>
        </template>
        <!-- User Menu -->
        ...
        <template v-else>
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'admin crypto default' }">
              <i class="ri-dashboard-line"></i>
              <span data-key="t-dashboard">{{ $t("t-dashboard") }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'admin crypto users' }">
              <i class="ri-user-line"></i>
              <span data-key="t-users">{{ $t("t-users") }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'admin crypto orders' }">
              <i class="ri-file-list-line"></i>
              <span data-key="t-orders">{{ $t("t-orders") }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'admin crypto Positions' }">
              <i class="ri-money-dollar-circle-line"></i>
              <span data-key="t-Positions">{{ $t("t-Positions") }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'admin crypto leads' }">
              <i class="ri-star-line"></i>
              <span data-key="t-leads">{{ $t("t-leads") }}</span>
            </router-link>
          </li>
          <!-- <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'admin crypto buy/sell' }">
              <i class="ri-exchange-line"></i>
              <span data-key="t-buy-sell">{{ $t("t-buy-sell") }}</span>
            </router-link>
          </li> -->
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'admin broker' }">
              <i class="ri-coin-line"></i>
              <span data-key="t-broker">{{ $t("t-broker") }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse menu-dropdown" id="sidebarProfile">
              <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                  <router-link to="/admin/profile" class="nav-link" data-key="t-my-account">
                    {{ $t("t-my-account") }}
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/admin/my-wallet" class="nav-link" data-key="t-wallet">
                    {{ $t("t-wallet") }}
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/admin/profile-setting" class="nav-link" data-key="t-settings">
                    {{ $t("t-settings") }}
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/admin/profile-kyc" class="nav-link" data-key="t-kyc">
                    {{ $t("t-kyc") }}
                  </router-link>
                </li>
              </ul>
          ...
          <li class="nav-item">
            <router-link class="nav-link menu-link" :to="{ name: 'admin crypto billing' }">
              <i class="ri-money-dollar-circle-line"></i>
              <span data-key="t-billing">{{ $t("t-billing") }}</span>
            </router-link>
          </li>
        ...
        <!-- here add admin menu if you wish -->
