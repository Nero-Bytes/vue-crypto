            ...
            <b-container>
                ...
                <b-collapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        ...
                        <li class="nav-item">
                            <b-link class="nav-link" href="#wallet">Wallet</b-link>
                        </li>
                        <li class="nav-item">
                            <b-link class="nav-link" href="#marketplace">Marketplace</b-link>
                        </li>
                        <li class="nav-item">
                            <b-link class="nav-link" href="#categories">Categories</b-link>
                        </li>
                        <li class="nav-item">
                            <b-link class="nav-link" href="#creators">Creators</b-link>
                        </li>
                    </ul>
