            ...
            <b-container>
                ...
                <b-collapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        ...
                        <li class="nav-item">
                            <b-link class="nav-link" href="#features">Features</b-link>
                        </li>
                        <li class="nav-item">
                            <b-link class="nav-link" href="#plans">Plans</b-link>
                        </li>
                        <li class="nav-item">
                            <b-link class="nav-link" href="#reviews">Reviews</b-link>
                        </li>
                        <li class="nav-item">
                            <b-link class="nav-link" href="#team">Team</b-link>
                        </li>
                        <li class="nav-item">
